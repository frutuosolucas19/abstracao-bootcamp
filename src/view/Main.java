...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Conteúdos Inscritos Melkih: " + devMelkih.getConteudosInscritos());
        devMelkih.progredir();
        System.out.println("----- LISTA ATUALIZADA -----");
        System.out.println("Conteúdos Inscritos Melkih: " + devMelkih.getConteudosInscritos());
        System.out.println("Conteúdos Concluidos Melkih: " + devMelkih.getConteudosConcluidos());
        ...
        System.out.println("Conteúdos Inscritos Jhonatan: " + devJhonatan.getConteudosInscritos());
        devJhonatan.progredir();
        devJhonatan.progredir();
        devJhonatan.progredir();
        System.out.println("----- LISTA ATUALIZADA -----");
        System.out.println("Conteúdos Inscritos Jhonatan: " + devJhonatan.getConteudosInscritos());
        System.out.println("Conteúdos Concluidos Jhonatan: " + devJhonatan.getConteudosConcluidos());
